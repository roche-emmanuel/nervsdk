...
NV_DEFINE_VECTOR(VoidPtr)
NV_DEFINE_VECTOR(Bool);
NV_DEFINE_VECTOR(I8);
NV_DEFINE_VECTOR(U8);
NV_DEFINE_VECTOR(I16);
NV_DEFINE_VECTOR(U16);
NV_DEFINE_VECTOR(I32);
NV_DEFINE_VECTOR(U32);
NV_DEFINE_VECTOR(I64);
NV_DEFINE_VECTOR(U64);
NV_DEFINE_VECTOR(F32);
NV_DEFINE_VECTOR(F64);
NV_DEFINE_VECTOR(String);
